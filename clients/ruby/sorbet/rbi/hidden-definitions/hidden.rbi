...
class Debase::AddAllBreakpoint
  RUBYGEMS_ACTIVATION_MONITOR = ::T.let(nil, ::T.untyped)
end

class Debase::AddBlockBreakpoint
  RUBYGEMS_ACTIVATION_MONITOR = ::T.let(nil, ::T.untyped)
end
...
class Debase::Breakpoint
  ...
  def initialize(_, _1, _2, _3, _4); end
...
class Debase::Breakpoint
  def self.find(_, _1, _2, _3); end

  def self.remove(_, _1); end
end
...
class Debase::Context
  ...
  def frame_label(*_); end

  def frame_line(*_); end

  def frame_self(*_); end

  def get_receiver_obj_id(); end

  def get_return_value_obj_id(); end

  def ignored?(); end

  def is_before_method(); end

  def is_on_leave(); end

  def location(); end

  def location_needed(); end

  def smart_step(_, _1); end
...
class Debase::StepVariantsCommand
  RUBYGEMS_ACTIVATION_MONITOR = ::T.let(nil, ::T.untyped)
end
...
class Debase::VarInstanceLimitCommand
  RUBYGEMS_ACTIVATION_MONITOR = ::T.let(nil, ::T.untyped)
end
...
class Debase::VarReceiverCommand
  RUBYGEMS_ACTIVATION_MONITOR = ::T.let(nil, ::T.untyped)
end

class Debase::VarReturnValueCommand
  RUBYGEMS_ACTIVATION_MONITOR = ::T.let(nil, ::T.untyped)
end
...
module Debase
  ...
  def self.configure_attach_session(); end
  ...
  def self.disable_all_iseqs(); end

  def self.each_child(_); end

  def self.enable_file_filtering(_); end

  def self.enable_test_verbose(); end

  def self.enable_trace_points(); end

  def self.handle_current_iseqs(_); end

  def self.handle_iseq(_, _1); end
...
class Etwin::Hammerfest::HammerfestUsername
  extend ::T::Private::Final::NoInherit
  extend ::T::Private::Methods::MethodHooks
  extend ::T::Private::Methods::SingletonMethodHooks
end
