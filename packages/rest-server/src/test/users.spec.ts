...
import { LinkToHammerfestMethod } from "@eternal-twin/core/lib/user/link-to-hammerfest-method";
import { $LinkToHammerfestWithCredentialsOptions } from "@eternal-twin/core/lib/user/link-to-hammerfest-with-credentials-options";
