import { $SimpleOauthClient, SimpleOauthClient } from "@eternal-twin/core/lib/oauth/simple-oauth-client";
import {
  $UpsertSystemClientOptions,
  UpsertSystemClientOptions
} from "@eternal-twin/core/lib/oauth/upsert-system-client-options";
