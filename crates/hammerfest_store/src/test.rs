...
use std::ops::Deref;
use etwin_core::hammerfest::{HammerfestStore, GetHammerfestUserOptions, HammerfestServer, HammerfestUserId, ShortHammerfestUser, HammerfestUsername};
    ...
    <TyHammerfestStore as Deref>::Target: HammerfestStore,
{
  ...
  let actual = api.hammerfest_store.get_short_user(&GetHammerfestUserOptions {
    server: HammerfestServer::HammerfestFr,
    id: HammerfestUserId::try_from_string(String::from("123")).unwrap(),
    time: None,
  }).await.unwrap();
